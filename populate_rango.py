...
def populate():
    python_pages = [
        {'title': 'Offical Python Tutorial', 'url':'https://docs.python.org/3/tutorial/'},
        {'title':'How to Think like a Computer Scientitst','url':'https://www.greenteapress.com/thinkpython/'},
